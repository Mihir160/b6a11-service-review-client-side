    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          ...
          in one cleaning solution, trusted by thousand clients.
        </h2>
        <p className="text-base text-gray-700 md:text-lg">
          Cleaning is often performed for aesthetic, hygienic, functional, environmental, or safety purposes.
        </p>
      </div>
        ...
        <div className="relative flex flex-col items-center h-full py-10 duration-300 bg-white rounded-sm transition-color sm:items-stretch sm:flex-row">
          <div className="px-12 py-8 text-center">
            ...
            <p className="text-center md:text-base">
              This percentage of people gave reviews.
            </p>
          </div>
          ...
          <div className="px-12 py-8 text-center">
            ...
            <p className="text-center md:text-base">
              So many people have taken service from us.
            </p>
          </div>
        </div>
      </div>
...
export default PeoplePercentange;